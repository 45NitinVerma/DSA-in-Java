...
public class Approach1 {
    ...
    private static void findCombinations(int[] candidates, int index, int target, List<Integer> currentSubset,
        ...
        for (int i = index; i < candidates.length; i++) {
            ...
            if (candidates[i] > target)
                break; // Optimization: stop if current number is greater than target
